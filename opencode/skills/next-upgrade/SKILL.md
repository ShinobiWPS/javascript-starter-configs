...
8. **Verify the upgrade**:
   - Run the development server and inspect key functionality
   - Run tests or `npm run build` only when the user explicitly requests them for the current upgrade
